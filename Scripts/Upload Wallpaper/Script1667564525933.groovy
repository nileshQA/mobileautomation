...
Mobile.tap(findTestObject('Object Repository/android.view.View (18)'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - nilesh Likhar (2)'), 0)

Mobile.tap(findTestObject('android.view.View (18)'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.EditText - Enter Description'), 0)

Mobile.sendKeys(findTestObject('Object Repository/android.widget.EditText - Enter Description (1)'), 'wallpaper')

Mobile.pressBack()

Mobile.tap(findTestObject('Object Repository/android.view.View (20)'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.view.View (21)'), 0)
